...
class Demo {
    ...
    public function getAllItemsOfUser($name,$mobile) {

      $stmt = $this->conn->prepare("SELECT list FROM usertransaction where name = ? and mobile = ?");
    ...
    public function getItemById($itemID){
      $stmt = $this->conn->prepare("SELECT * FROM items where itemID = ? ");
